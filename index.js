...
const syncModelsAndAssociations = async () => {
	...
	// refer to https://sequelize.org/docs/v6/core-concepts/model-basics/ for sync options. Specifically force and alter.
...
const runMonitor = async () => {
	...
	// let { fulfillmentType } = await AmazonScraper.getASINInformation("B00AFV4DVG");
