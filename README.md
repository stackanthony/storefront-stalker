...
<img src="https://img.shields.io/github/languages/top/stackanthony/amztools?style&color=5D6D7E" alt="GitHub top language" />
<img src="https://img.shields.io/github/languages/code-size/stackanthony/amztools?style&color=5D6D7E" alt="GitHub code size in bytes" />
<img src="https://img.shields.io/github/commit-activity/m/stackanthony/amztools?style&color=5D6D7E" alt="GitHub commit activity" />
...
| **🔀 Version Control** | The codebase uses Git for version control, providing the ability to track changes, manage branches, and collaborate with multiple contributors. |
...
| File                                                                                    | Summary                                                                                                                                                                                                                                           |
| --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [deploy-commands.js](https://github.com/stackanthony/amztools/blob/main/deploy-commands.js) | This code snippet reads the command files from a specified directory, converts their data to JSON format, and deploys them as slash commands to a Discord guild using the Discord REST API. Any errors encountered during the process are logged. |
| [index.js](https://github.com/stackanthony/amztools/blob/main/index.js)                     | The code initializes a discord.js client, loads commands from files, syncs a database, and handles interactions and autocompletions. It also runs a constant monitor for new Amazon products.                                                     |
...
| File                                                                                 | Summary                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ping.js](https://github.com/stackanthony/amztools/blob/main/src/commands/basic/ping.js) | The code snippet exports a slash command called "ping" using the Discord.js library. When executed, it logs the user who triggered the command and replies to the interaction with "Pong! |
